...
class MenuItemAdmin(admin.ModelAdmin):
    list_display = (
    'name', 'category', 'price', 'status', 'calculated_calories', 'is_vegetarian', 'is_vegan', 'is_gluten_free')
    list_filter = ('category', 'status', 'is_vegetarian', 'is_vegan', 'is_gluten_free')
    search_fields = ('name', 'description', 'category__name')
    list_editable = ('price', 'status')
    readonly_fields = (
    'calculated_calories', 'calculated_protein', 'calculated_fat', 'calculated_carbs', 'allergens_display')

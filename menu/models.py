...
class MenuItem(models.Model):
    ...
    image = models.ImageField(
        upload_to="menu_images/", blank=True, null=True, verbose_name=_("Фотография")
    )
    ...
    recipe_instructions = models.TextField(
        blank=True, null=True, verbose_name=_("Инструкции по приготовлению")
    )
...
class Modifier(models.Model):
    ...
    price_change = models.DecimalField(
        max_digits=8, decimal_places=2, default=0.00, verbose_name=_("Изменение цены")
    )

...
class Category(models.Model):
    ...
    image = models.ImageField(
        upload_to="menu_categories/", blank=True, null=True, verbose_name=_("Изображение")
    )
...
class Allergen(models.Model):
    ...
    icon = models.ImageField(
        upload_to="allergen_icons/", blank=True, null=True, verbose_name=_("Иконка")
    )
...
class Ingredient(models.Model):
    ...
    name = models.CharField(max_length=100, verbose_name=_("Название ингредиента"))
    description = models.TextField(blank=True, null=True, verbose_name=_("Описание"))
    image = models.ImageField(
        upload_to="ingredient_images/", blank=True, null=True, verbose_name=_("Изображение")
    )
    ...
    is_vegetarian = models.BooleanField(default=False, verbose_name=_("Вегетарианский"))
    is_vegan = models.BooleanField(default=False, verbose_name=_("Веганский"))
...
class MenuItem(models.Model):
    ...
    name = models.CharField(max_length=100, verbose_name=_("Название блюда"))
    description = models.TextField(blank=True, null=True, verbose_name=_("Описание"))
    category = models.ForeignKey(
        Category, on_delete=models.PROTECT, related_name="menu_items", verbose_name=_("Категория")
    )
    ...
    image = models.ImageField(
        upload_to="menu_items/", blank=True, null=True, verbose_name=_("Основное изображение")
    )
    ...
    is_signature = models.BooleanField(default=False, verbose_name=_("Фирменное блюдо"))
    ...
    spicy_level = models.PositiveSmallIntegerField(
        choices=SpicyLevel.choices, default=SpicyLevel.NOT_SPICY, verbose_name=_("Уровень остроты")
    )

    serving_size = models.CharField(
        max_length=50, blank=True, null=True, verbose_name=_("Размер порции")
    )
    preparation_time = models.PositiveSmallIntegerField(
        blank=True, null=True, verbose_name=_("Время приготовления (мин)")
    )

    restaurant = models.ForeignKey(
        Restaurant, on_delete=models.CASCADE, related_name="menu_items", verbose_name=_("Ресторан")
    )

    is_active = models.BooleanField(default=True, verbose_name=_("Активно"))

    order_in_category = models.PositiveIntegerField(
        default=0, verbose_name=_("Порядок в категории")
    )
    ...
    def calculate_total_nutrition(self):
        ...
        for item_ingredient in self.menuitemingredient_set.all():
            weight_ratio = Decimal(item_ingredient.amount_grams) / Decimal("100.0")
    ...
    def get_allergens(self):
        ...
        """
        allergens = set()
        for item_ingredient in self.menuitemingredient_set.select_related(
            "ingredient"
...
class MenuItemIngredient(models.Model):
    ...
    menu_item = models.ForeignKey(
        MenuItem, on_delete=models.CASCADE, verbose_name=_("Позиция меню")
    )
    ingredient = models.ForeignKey(
        Ingredient, on_delete=models.PROTECT, verbose_name=_("Ингредиент")
    )
...
class Modifier(models.Model):
    ...
    restaurant = models.ForeignKey(
        Restaurant, on_delete=models.CASCADE, related_name="modifiers", verbose_name=_("Ресторан")
    )

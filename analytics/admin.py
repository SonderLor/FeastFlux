...
class DailySalesAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (_("Пиковая нагрузка"), {"fields": ("peak_hour_orders", "peak_hour_sales")}),
        (_("Система"), {"fields": ("updated_at",), "classes": ("collapse",)}),
    )
...
class PopularItemAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {"fields": ("restaurant", "menu_item", "date_period")}),
        (_("Статистика заказов"), {"fields": ("total_orders", "total_quantity", "total_revenue")}),
        (_("Пользовательский опыт"), {"fields": ("average_rating", "last_ordered")}),
        (_("Система"), {"fields": ("updated_at",), "classes": ("collapse",)}),
    )
    ...
    def update_items_popularity(self, request, queryset):
        ...
        self.message_user(
            request, _(f"Данные о популярности обновлены для {count} периодов/ресторанов.")
        )
...
class StaffPerformanceAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {"fields": ("restaurant", "staff", "date_period")}),
        (
        ...
        (_("Показатели для кухни"), {"fields": ("items_prepared", "average_preparation_time")}),
        (_("Общие показатели"), {"fields": ("hours_worked", "get_sales_per_hour")}),
        (_("Система"), {"fields": ("updated_at",), "classes": ("collapse",)}),
    )
...
class TableOccupancyAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {"fields": ("restaurant", "table", "date")}),
        (
        ...
        (_("Финансовые показатели"), {"fields": ("total_revenue", "get_revenue_per_hour")}),
        (_("Система"), {"fields": ("updated_at",), "classes": ("collapse",)}),
    )
...
class NutritionalAnalyticsAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {"fields": ("restaurant", "date_period", "total_orders")}),
        (
        ...
        (_("Аллергены"), {"fields": ("format_common_allergens",)}),
        (_("Система"), {"fields": ("updated_at",), "classes": ("collapse",)}),
    )
...
class CustomerSegmentAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {"fields": ("name", "description", "restaurant")}),
        (
...
class CustomerInsightAdmin(admin.ModelAdmin):
    ...
    readonly_fields = (
        "updated_at",
        "format_favorite_items",
        "format_dietary_preferences",
        "format_allergens",
        "format_purchase_patterns",
        "get_lifetime_value",
    )
    fieldsets = (
        (None, {"fields": ("customer", "segment")}),
        (
            _("История покупок"),
            {
                "fields": (
        ...
        (_("Поведение"), {"fields": ("feedback_rating_avg", "format_purchase_patterns")}),
        (_("Система"), {"fields": ("updated_at",), "classes": ("collapse",)}),
    )

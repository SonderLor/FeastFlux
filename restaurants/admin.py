...
class RestaurantAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {"fields": ("name", "logo", "description", "is_active")}),
        (
            _("Контактная информация"),
            {"fields": ("address", "city", "postal_code", "country", "phone", "email", "website")},
        ),
        (_("Часы работы"), {"fields": ("opening_hours",)}),
        (_("Управление"), {"fields": ("managers",)}),
        (
...
class TableAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ("created_at", "updated_at")
    fieldsets = (
        (None, {"fields": ("restaurant", "number", "capacity", "status", "is_active")}),
        (
        ...
        (_("Финансы"), {"fields": ("min_spend",), "classes": ("collapse",)}),
        (
            _("Дополнительная информация"),
            {"fields": ("created_at", "updated_at"), "classes": ("collapse",)},
        ),
...
class ReservationAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {"fields": ("restaurant", "table", "status")}),
        (_("Клиент"), {"fields": ("customer_name", "customer_email", "customer_phone", "user")}),
        (
        ...
        (
            ...
            {"fields": ("dietary_preferences", "allergy_information"), "classes": ("collapse",)},
        ),
        (
            _("Система"),

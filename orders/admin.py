...
class OrderAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ('created_at', 'last_modified', 'total_amount', 'nutrition_summary', 'allergens_summary')
    ...
    fieldsets = (
        (None, {
            'fields': ('status', 'order_type', 'table', 'waiter', 'comments')
        }),
        ('Сумма и время', {
    ...
    def nutrition_summary(self, obj):
        ...
        return (f"Ккал: {nutrition['calories']}, "

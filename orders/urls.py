...
urlpatterns = [
    ...
    path(
        "customer/cart/update/<uuid:item_id>/",
        views.customer_update_cart_item,
        name="customer_update_cart_item",
    ),
    path(
        "customer/cart/remove/<uuid:item_id>/",
        views.customer_remove_cart_item,
        name="customer_remove_cart_item",
    ),
    ...
    path(
        "<uuid:id>/edit/update-item/<uuid:item_id>/",
        views.update_order_item,
        name="update_order_item",
    ),
    path(
        "<uuid:id>/edit/remove-item/<uuid:item_id>/",
    ...
    path(
        "discounts/<uuid:id>/toggle-status/",
        views.discount_toggle_status,
        name="discount_toggle_status",
    ),
